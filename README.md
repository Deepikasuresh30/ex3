...
<html>
<head>
    <title>SLOT TIME TABLE - MADHUPRIYA , 212224040177</title>
    <style>
        table {
...
<body>
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - MADHUPRIYA(212224040177) </strong></p>
    </div>
    <table>
        <tr>
...
## OUTPUT
<img width="960" alt="2025-04-22" src="https://github.com/user-attachments/assets/564f9647-09bc-498e-88d0-2ed4cd9e6744" />
